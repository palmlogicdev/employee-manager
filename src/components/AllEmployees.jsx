        ...
        <div id="all_employee" className="p-4">
            <div className="overflow-x-auto rounded shadow-lg bg-white">
                <table className="min-w-full text-sm text-gray-700">
                    <thead className="bg-linear-to-r from-blue-500 to-indigo-500 text-white text-center">
                        <tr>
                    ...
                    <tbody>
                        ...
                        employee.map((data) => (
                            <tr
                                key={data.id}
                                className="border-b border-gray-200 hover:bg-gray-100 transition-all text-center"
                                >
                                ...
                                <td className={`px-6 py-3 text-white font-bold text-center ${data.status === 'active' ? 'bg-green-600' : 'bg-red-600'}`}>{data.status}</td>
